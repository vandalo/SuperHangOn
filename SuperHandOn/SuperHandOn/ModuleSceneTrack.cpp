...
void ModuleSceneTrack::PrintTrack()
{
	...
	for (int n = startPos; n < startPos + 300; n++) {
		...
		for (int i = numRalles; i > 0; i--) {
			if(i % 2 == 0)
				App->renderer->DrawPoly(Green, (short)p.X, (short)p.Y, (short)(p.W*0.3*i), (short)l.X, (short)l.Y, (short)(l.W*0.3*i));
			else
				App->renderer->DrawPoly(grass, (short)p.X, (short)p.Y, (short)(p.W*0.3*i), (short)l.X, (short)l.Y, (short)(l.W*0.3*i));
		}
