...
bool ModuleSceneIntro::Start()
{
	...
	graphics = App->textures->Load("resources/sprites/segaLogo.bmp");
	App->renderer->camera.x = App->renderer->camera.y = 0;

	//Load all fonts
	App->menusFont = App->font->LoadMedia("resources/fonts/font18x30.png", "9876543210", 18, 30);
...
update_status ModuleSceneIntro::Update(const float deltaTime)
{
